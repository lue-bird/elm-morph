...
because `aSemanticallyInfixFunction` covers `atLeast`/`atMost`/... which can be used here: `ArraySIzed.Morph.atLeast n3 AToZ.Morph.char`
...
config =
    ...
    , NoUnused.Exports.rule
        |> Rule.ignoreErrorsForFiles [ "src/N/Local.elm" ]
